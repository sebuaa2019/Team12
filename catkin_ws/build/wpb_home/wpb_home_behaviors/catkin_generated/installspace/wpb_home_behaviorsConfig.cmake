...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wpb_home_behaviors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nipo/AndroidStudioProjects/RobotApp/catkin_ws/install/${idir}'.  ${_report}")
    endif()
